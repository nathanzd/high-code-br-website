        ...
        <div className="max-w-8xl container relative mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
              ...
              Transformamos ideias em soluções inteligentes com Power Platform, Power BI e desenvolvimento web. Potencialize seus resultados com tecnologia de ponta e inovação personalizada.
              </Typography>
            </div>
          </div>
        </div>
